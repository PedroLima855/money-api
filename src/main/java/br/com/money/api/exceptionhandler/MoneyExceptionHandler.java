...
public class MoneyExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public MoneyExceptionHandler(MessageSource messageSource) {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		List<Erro> erros = Arrays.asList(new Erro(mensagemUsusario, mensagemDev));
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex,
		...
		String mensagemUsusario = messageSource.getMessage("recurso.operacao-nao-permitida", null, LocaleContextHolder.getLocale());
